...
void NormalizedAm_And_CalculateTHD(float *Phase_Pointer, float *NormAm_Pointer, u16 *Fx_Vpp_Pointer, float *THD_Pointer, float *Am_Data_Pointer)
{
    ...
    Fx_Vpp_Pointer[0] = FX_VPP_MULTIPLE * Am_Data_Pointer[Fx_Index[0]] * ADC_RF_V_MV * 4 / ADC_SAMPLING_NUM / ADC_MAX;
    ...
    for (i = 1; i < 5; ++i)
    {
        ...
        /* 幅值计算 */
        Fx_Vpp_Pointer[i] = FX_VPP_MULTIPLE * Am_Data_Pointer[Fx_Index[i]] * ADC_RF_V_MV * 4 / ADC_SAMPLING_NUM / ADC_MAX;
